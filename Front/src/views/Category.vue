<template>
  ...
  <main>
    <div class="left-bar">
      <li @click="redirect('/category') "  class="active">Category</li>
    ...
    <div class="right-side">
      <div class="action">
        ...
        <button @click="open_category" style="margin-bottom: 10px; margin-top: 5px;border-radius: 7px;margin-right: 10px;background-color: rgb(206, 162, 105); ">Add new</button>
      </div>
...
export default {
  ...
  methods: {
    ...
    add_new(){
      ...
      axios.post('http://localhost:3000/category/create_category', data)
        .then((response) => {
    ...
    edit_new(){
      ...
      axios.put('http://localhost:3000/category/update_category', data)
      .then((response) => {
        if (response.status === 200){
    ...
    delete_category(_id){
      const data = {_id: _id}
      axios.delete('http://localhost:3000/category/delete_category', {data: data})
        .then((response) => {
    ...
    remount(){
      axios.get('http://localhost:3000/category/get_categories')
        .then((response) => {
