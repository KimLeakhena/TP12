<template>
  ...
  <main>
    <div class="left-bar">
      ...
      <li @click="redirect('/subcategory')" class="active" >Subcategory</li>
      <li @click="redirect('/product')" >Product</li>
    </div>
    <div class="right-side">
      <div class="action">
        <p style="padding-left:10px ;">Sub Category</p>
      ...
      <table class="GeneratedTable">
        ...
        <tbody>
          <tr v-for="subcategory in subcategories" :key="subcategory">
            ...
            <td></td>
            <td>
              <button @click="delete_subcategory(subcategory._id)" style="margin-bottom:10px ;">Delete</button>
              <button @click="open_edit_subcategory(subcategory._id, subcategory.subcategory_name)" style="margin-bottom:10px ;">Edit</button>
            </td>
          </tr>
        </tbody>
      </table>
